...
<div class="fixed top-4 z-[500] w-full max-w-md px-4">
    <p class="hidden text-red-700 bg-red-50 border border-red-200 rounded-md px-4 py-2 shadow" id="permission_error"></p>
    <p class="hidden text-red-700 bg-red-50 border border-red-200 rounded-md px-4 py-2 shadow" id="server_error"></p>
</div>
